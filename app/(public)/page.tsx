      ...
      <div className="flex flex-col">
        ...
        <section className="relative z-0 bg-[#FDFDFD] px-4 py-10 md:px-6 md:py-16 lg:px-[120px] lg:py-[100px]">
          <div className="container mx-auto max-w-[1440px]">
            <div className="mb-12 text-center">
              <h2
                className="mb-4 font-display text-4xl font-bold text-cozetik-black md:text-5xl lg:text-6xl"
        ...
        <section className="relative bg-white px-4 py-16 md:px-6 md:py-20 lg:px-[120px] lg:py-24">
          <div className="container mx-auto max-w-[1200px]">
            <h2
              className="mb-6 font-display text-4xl font-bold text-cozetik-black md:text-5xl lg:text-6xl text-center"
              style={{ fontFamily: "var(--font-bricolage), sans-serif" }}
            >
              Notre vision
            </h2>
