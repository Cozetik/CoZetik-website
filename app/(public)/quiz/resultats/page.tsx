  ...
  return (
    <div className="bg-white font-sans">
      ...
      <section className="relative bg-cozetik-black pb-10">
        <div className="container mx-auto px-20">
          <div className="relative">
            <div className="absolute -right-20 top-0 h-64 w-64 rounded-full bg-cozetik-violet opacity-30 blur-3xl"></div>
            <div className="relative w-fit overflow-hidden bg-cozetik-black pl-[70px] pr-[150px] py-[100px] translate-y-40 md:translate-y-60">
      ...
      <section className="bg-cozetik-beige py-20 md:py-24 pt-50 md:pt-60">
        <div className="container mx-auto px-20 max-w-5xl">
          <div className="flex items-start gap-6 mb-6">
            <div className="flex-shrink-0 w-16 h-16 rounded-full bg-cozetik-violet/20 flex items-center justify-center">
          ...
          <div className="container mx-auto px-20 max-w-5xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {recommendation.complementary_modules.map((module, index) => (
                <div
                  key={index}
                  className="bg-white p-8 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 border-l-4 border-cozetik-violet"
                >
