import { Clock, Award, Euro, Calendar, Users, CheckCircle } from 'lucide-react'
...
export default function FormationKeyInfos({ formation }: FormationKeyInfosProps) {
  const infos = [
    {
      icon: Clock,
    ...
    {
      icon: Users,
      value: formation.maxStudents ? `${formation.maxStudents} max` : 'Illimité',
      label: 'Par session',
