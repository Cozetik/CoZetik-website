...
export default function AddOptionDialog({
  ...
  const onSubmit = async (values: FormValues) => {
    ...
    try {
      const response = await fetch(`/api/quiz/questions/${questionId}/options`, {
        method: 'POST',
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          <DialogTitle>Nouvelle option de réponse</DialogTitle>
          <DialogDescription>
            Ajoutez une nouvelle option de réponse à cette question
          </DialogDescription>
        </DialogHeader>
