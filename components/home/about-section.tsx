...
export function AboutSection() {
  ...
  const handleExploreClick = () => {
    // 1. On active l'état pour afficher le rideau local
    setIsNavigating(true);

    // 2. On pose le drapeau pour la page suivante
    if (typeof window !== "undefined") {
      sessionStorage.setItem("from-home-explore", "true");
    }

    // 3. On attend EXACTEMENT la durée de l'animation (800ms) avant de changer de page
    setTimeout(() => {
  ...
  return (
    <>
          ...
          >
            ...
            <div className="bg-cozetik-beige p-8 md:p-12 lg:p-16">
              ...
              <p className="mt-6 max-w-[600px] font-sans text-base leading-[150%] text-cozetik-black md:text-lg">
                ...
                obtiendrez des certifications reconnues et construirez votre
                avenir professionnel. Préparez-vous concrètement à votre future
                carrière en nos parcours dès aujourd&apos;hui
              </p>
      ...
      {/* Page Transition Overlay - HORS de la section pour éviter overflow-hidden */}
